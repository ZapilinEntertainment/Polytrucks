...
public class Car : MonoBehaviour {
    ...
    private WheelRaycastResult HandleWheel(GameObject wheel, bool isFront) {
        ...
        var amount = GetSuspensionAmount(hit.distance);
    ...
    virtual protected float GetSuspensionAmount(float distance) => Round(1f - distance / SuspensionLength, 2);

    protected static float Round(float value, int digits) {
